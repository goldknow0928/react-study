 ...
 * - ReactChartjs2 라는 Wrapper 라이브러리를 통해 React에서 사용 가능하다
 *
...
const ChartEx = memo(() => {
    ...
    // 가로 막대 그래프를 위한 옵션 --> 인덱스툭이 y축임을 추가로 지정함
    ...
    // 선 그래프를 위한 데이터 정의
    const covid19 = {
        labels: ["06/18", "06/19", "06/20", "06/21", "06/22", "06/23"],
        datasets: [
            {
                label: "서울시 확진자",
                data: [1237, 1108, 719, 1775, 1580, 1605],
                backgroundColor: "rgba(255,99,132,0.5)",
                borderColor: "rgba(255,99,132,1)",
                borderWidth: 1,
            },
    ...
    // 레이더 그래프를 위한 데이터 정의
    const student = {
        labels: ["컴퓨터 활용", "퍼블리싱", "프론트엔드", "백엔드", "데이터베이스"],
        datasets: [
            {
                label: "점수",
                data: [72, 95, 94, 77, 82],
